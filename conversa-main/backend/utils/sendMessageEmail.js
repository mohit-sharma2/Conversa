...
const { BREVO_API_KEY, EMAIL, FRONTEND_URL } = require("../secrets.js"); // ✅ CHANGED: Resend → Brevo
...
<body style="margin:0;padding:0;background-color:#f0f2f5;font-family:'Segoe UI',Helvetica,Arial,sans-serif;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#f0f2f5;padding:40px 0;">
    ...
    // ✅ CHANGED: Brevo HTTP API ke saath fire-and-forget (fetch built-in Node 18+)
...
// const { RESEND_API_KEY, FRONTEND_URL } = require("../secrets.js"); // ✅ CHANGED
...
//     // ✅ CHANGED: resend ke saath fire-and-forget
//     resend.emails.send({
