...
const { JWT_SECRET, BREVO_API_KEY, EMAIL } = require("../secrets.js"); // ✅ CHANGED: Resend → Brevo

// ✅ CHANGED: Helper - Brevo HTTP API se email bhejna (fetch built-in hai Node 18+)
const sendEmail = async ({ to, subject, html }) => {
  const response = await fetch("https://api.brevo.com/v3/smtp/email", {
    ...
    body: JSON.stringify({
      sender: { name: "Conversa", email: EMAIL }, // ⚠️ EMAIL must be verified in Brevo as a Sender
      to: [{ email: to }],
      subject,
      htmlContent: html,
    }),
...
// const bcrypt = require("bcryptjs");
// const jwt = require("jsonwebtoken");
// const { Resend } = require("resend"); //  CHANGED: nodemailer → resend
// const User = require("../Models/User.js");
// const Conversation = require("../Models/Conversation.js");
// const { JWT_SECRET, RESEND_API_KEY, EMAIL } = require("../secrets.js"); //  CHANGED

// const resend = new Resend(RESEND_API_KEY); //  CHANGED

// //  Helper: email bhejne ka common function
// const sendEmail = async ({ to, subject, html }) => {
